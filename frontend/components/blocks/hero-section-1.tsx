                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <Link
                                        ...
                                        <span className="text-foreground text-sm">Introducing CrossFi Network Support</span>
                                    ...
                                    <h1
                                        ...
                                        Your AI Agent for CrossFi Network
                                    </h1>
                                    <p
                                        className="mx-auto mt-8 max-w-2xl text-balance text-lg">
                                        Deploy contracts, create tokens, schedule payments, and interact with CrossFi blockchain using simple chat commands. Powered by Google Gemini AI.
                                    </p>
                                </AnimatedGroup>
                    ...
                    <div className="mx-auto max-w-7xl px-6">
                        ...
                        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3">
                            ...
                            <div className="group rounded-xl border p-6 hover:border-primary/50">
                                ...
                                <p className="text-muted-foreground">Deploy smart contracts, create tokens, and mint NFTs with simple chat commands on CrossFi Network.</p>
                            </div>
                        ...
                        <div className="grid items-center gap-12 lg:grid-cols-2">
                            <div>
                                ...
                                <p className="mb-6 text-muted-foreground">
                                    Astra CrossFi employs cutting-edge technology designed for performance, security, and seamless blockchain interactions on CrossFi Network.
                                </p>
                                ...
                                <ul className="space-y-4">
                                    ...
                                    <li className="flex items-start gap-2">
                                        ...
                                        <span><strong>Blockchain:</strong> CrossFi Network L2 with Solidity smart contracts</span>
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <div className="flex-shrink-0 text-primary">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide">
                        ...
                        <div className="grid gap-8 justify-center">
                            ...
                            <div className="flex flex-col rounded-xl border border-primary bg-card p-8 relative max-w-md mx-auto">
                                ...
                                <div className="mb-6">
                                    ...
                                    <p className="text-muted-foreground">Full platform access on CrossFi testnet</p>
                                </div>
                  ...
                  testimonials={[
                    {
                      ...
                      text: "Astra CrossFi has completely transformed how I interact with smart contracts. Deploying an NFT collection used to take hours, now it's done in minutes with a simple chat command!",
                      href: "https://twitter.com/sarahdev"
                    },
                    {
                      author: {
                        name: "Marcus Thompson",
                        handle: "@marcuscrossfi",
                    ...
                    <div className="mx-auto max-w-7xl px-6">
                        <div className="grid gap-8 md:grid-cols-4">
                            <div className="md:col-span-2">
                                ...
                                <p className="mb-4 max-w-xs text-muted-foreground">
                                    Your AI agent for seamless blockchain interactions on CrossFi Network.
                                </p>
                        ...
                        <div className="mt-10 border-t pt-6">
                            <p className="text-center text-xs text-muted-foreground">
                                © {new Date().getFullYear()} Astra CrossFi. All rights reserved. Built for CrossFi Network with ❤️
                            </p>
                        </div>
                    </div>
                </footer>
